...
/**
 * This class provides a wrapper for network errors when making requests to Organization structure API
 */
export class LuccaOrganizationError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "LuccaOrganizationError";
